...
/**
 * UploaddatadukungSearch represents the model behind the search form of `common\models\Uploaddatadukung`.
 */
class UploaddatadukungSearch extends Uploaddatadukung
{
    /**
     * {@inheritdoc}
     */
