...
use common\models\UploaddatadukungSearch;
use yii\web\Controller;
use yii\web\NotFoundHttpException;
use yii\filters\VerbFilter;

/**
 * UploaddatadukungController implements the CRUD actions for Uploaddatadukung model.
 */
class UploaddatadukungController extends Controller
{
    ...
    {
        $searchModel = new UploaddatadukungSearch();
